...
prefs.hardware['audioLib'] = 'ptb' #Psychtoolbox (PTB)
prefs.hardware['audioLatencyMode'] = '3'
from psychopy import visual, core, logging, monitors, gui
...
ExcelFile='E:/Investigacion/Exp/Trial/Data.xlsx'
ImageFolder='E:/Investigacion/Exp/'
ExcerptFolder='E:/Investigacion/Exports30/'

# Monitor
widthPix = 1920 # screen width in px
heightPix = 1080 # screen height in px
monitorwidth = 35.4 # 53.1 # monitor width in cm
...
#This dialogue box fix the resolution problem / 5_3_24
bx = gui.DlgFromDict(dictionary={},title='Start routines',show=False)
bx.addText('Press OK to start the experimental process.')
bx.show()
if bx.OK == False:
    core.quit()
...
#Randomization in two blocks / 5_3_24
videos1 = UserRow[1:len(UserRow)-4]
videos2 = UserRow[len(UserRow)-4:]
random.shuffle(videos1)
...
#window
win = visual.Window(
    size=(widthPix,heightPix), screen=0,
    winType='pyglet', allowStencil=False,
    monitor=MonExp, color=[0,0,0], colorSpace='rgb',
    backgroundImage='', backgroundFit='none',
    blendMode='avg', useFBO=True, 
    units='height')#fullscr=True // monitor='testMonitor' / MonExp // size=(1024, 768) // waitBlanking=False,
...
for Adr in videos:
    ...
    if Metadata[2]==1:
        ...
        Orden=[0,1,2,3]
    elif Metadata[2]==5: # 5_3_24
        Orden=[0,1,2,3,4]
    elif Metadata[2]==7:  # 5_3_24
        Orden=[0,1,2,3,4,5,6]
    ...
    while continueRoutine:
        ...
        if movie.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            #Trigger start
            print('OUTPUT Ch1:','Start_'+Metadata[0]) #OUTPUT / NIELS
            Registro.write('Start_'+Metadata[0]+'\n') #5_3_24
            #print(movie.getFPS())
        ...
        if continueRoutine:  # don't flip if this routine is over or we'll get a blank screen / niels
            ...
            for VarOrd in Orden: #CHECK FOR OUTPUT / NIELS
                if FrameCounter==listado[VarOrd] and routineTimer.getTime()-tp>0.9: #-1 para revision del frame blanco
                    ...
                    Registro.write('OUTPUT: Ch1: Trigger_'+Metadata[0] +' /// Ch2: '+str(VarOrd+1)+' of '+str(Metadata[2])+' /// Ch3: '+ str(Cut[VarOrd])+ ' /// Ch4: '+ str(Kind[VarOrd])+ ' /// Ch5:'+ str(Metadata[5])+'\n') #5_3_24
                #elif FrameCounter==listado[VarOrd] and routineTimer.getTime()-tp<0.9:
                    #print('ERROR:',VarOrd+1,'of',Metadata[2],'; TIEMPO:',routineTimer.getTime()-tp)
    ...
    Registro.write('End_'+Metadata[0]+'\n\n') #5_3_24
